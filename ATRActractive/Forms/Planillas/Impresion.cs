...
namespace ATRActractive.Forms.Planillas
{
    class Impresion
    {
        ...
        private List<Planilla_Cierre> datosPlanilla = new List<Planilla_Cierre>();

        private CN_Venta cnFactura = new CN_Venta();

        private Planilla_Cierre reportePlanilla = new Planilla_Cierre();

        public Planilla_Cierre ReportePlanilla { get => reportePlanilla; set => reportePlanilla = value; }
